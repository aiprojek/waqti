...
export const en = {
    ...
    main: {
        ...
        offlineUsingCache: 'Offline: using cached schedule',
    ...
    settings: {
        ...
        status: {
            ...
            ready: 'Ready.',
            error: 'Error.',
            assetsProgress: '{{cached}}/{{total}} assets cached.',
            assetsCheckError: 'Could not check cached assets.',
        },
        general: {
            ...
            offlineAssets: {
                ...
                description: 'Download default images and sounds so media stays available without internet.',
                descriptionNative: 'Optional: download extra images and sounds for offline use.',
                download: 'Download Media',
                downloadNative: 'Download Extra Media',
                downloading: 'Downloading...',
                ready: 'Media Ready (Offline Mode Available)',
                success: 'Assets downloaded successfully!',
                shellTitle: 'App Shell',
                shellReady: 'Ready',
                shellMissing: 'Not Cached',
                mediaTitle: 'Media',
                mediaReady: 'Cached',
                mediaMissing: 'Not Cached',
                mediaTooltip: 'Images and sounds used by the app.',
                prayerTitle: 'Prayer Times',
                prayerReady: 'Cached',
                prayerMissing: 'Not Cached',
                prayerTooltip: 'Prayer time cache from API or calculated mode.',
                shellTooltip: 'Core app files required to open the app offline.',
                nativeBadge: 'Native'
            },
            remote: {
                title: 'Remote Control',
                description: 'Scan this QR Code with your phone to control the display remotely.',
                unavailable: 'Pairing code is not available. Check internet connection.',
                ...
                bluetoothEnable: 'Enable Bluetooth Host (Android)',
                bluetoothHostOn: 'Bluetooth host active',
                bluetoothHostOff: 'Bluetooth host inactive',
                bluetoothHostUnsupported: 'Bluetooth not supported',
                bluetoothHostError: 'Bluetooth status error',
                bluetoothHostUnknown: 'Bluetooth status unknown',
                bluetoothError: 'Unable to read Bluetooth status'
            },
            promo: {
        ...
        display: {
            ...
            ecoMode: {
                enable: 'Enable Eco Mode (Extreme Performance)',
                help: 'Disables complex animations, blur effects, and shadows. Highly recommended for low-end Android boxes or Raspberry Pi.'
            },
            sleepMode: {
        ...
        remote: {
            ...
            authFailedTitle: 'Pairing Failed',
            authFailedDesc: 'Pairing token invalid or expired. Re-scan the QR from the TV.',
            authPending: 'Verifying pairing token...',
            retry: 'Retry',
            prev: 'Prev',
            next: 'Next',
            stop: 'Stop',
            ...
            tooltipWifi: 'Use Wi-Fi/WebRTC (requires local network + internet).',
            tooltipBluetooth: 'Use Bluetooth (requires Android host + Chrome on phone).',
            bluetoothHint: 'Use Bluetooth if there is no local network. Requires Chrome on phone.',
            bluetoothHostNote: 'Host must be the Android build with Bluetooth Host enabled.',
            bluetoothUnsupported: 'Web Bluetooth is not supported in this browser.',
            bluetoothConnect: 'Connect Bluetooth',
            bluetoothConnected: 'Connected',
            bluetoothConnecting: 'Connecting...',
            bluetoothReady: 'Ready to send commands',
            bluetoothNotConnected: 'Bluetooth is not connected.',
            bluetoothSendFailed: 'Failed to send via Bluetooth.'
        }
    },
    info: {
        title: 'About & Guide',
