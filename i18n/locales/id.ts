...
export const id = {
    ...
    main: {
        ...
        offlineUsingCache: 'Offline: memakai jadwal dari cache',
    ...
    settings: {
        ...
        status: {
            ...
            ready: 'Siap.',
            error: 'Error.',
            assetsProgress: '{{cached}}/{{total}} aset tersimpan.',
            assetsCheckError: 'Tidak bisa mengecek aset cache.',
        },
        general: {
            ...
            offlineAssets: {
                title: 'Aset Offline',
                description: 'Unduh gambar dan suara bawaan agar media tetap tersedia tanpa internet.',
                descriptionNative: 'Opsional: unduh gambar dan suara tambahan untuk penggunaan offline.',
                download: 'Unduh Media',
                downloadNative: 'Unduh Media Tambahan',
                downloading: 'Mengunduh...',
                ready: 'Media Siap (Mode Offline Tersedia)',
                success: 'Aset berhasil diunduh!',
                shellTitle: 'App Shell',
                shellReady: 'Siap',
                shellMissing: 'Belum Tersimpan',
                mediaTitle: 'Media',
                mediaReady: 'Tersimpan',
                mediaMissing: 'Belum Tersimpan',
                mediaTooltip: 'Gambar dan suara yang dipakai aplikasi.',
                prayerTitle: 'Jadwal Shalat',
                prayerReady: 'Tersimpan',
                prayerMissing: 'Belum Tersimpan',
                prayerTooltip: 'Cache jadwal shalat dari API atau mode hitung lokal.',
                shellTooltip: 'File inti aplikasi agar bisa dibuka offline.',
                nativeBadge: 'Native'
            },
            remote: {
                title: 'Remote Control',
                description: 'Scan QR Code ini menggunakan HP Anda untuk mengontrol tampilan dari jarak jauh.',
                unavailable: 'Kode pairing belum tersedia. Periksa koneksi internet.',
                ...
                bluetoothEnable: 'Aktifkan Host Bluetooth (Android)',
                bluetoothHostOn: 'Host Bluetooth aktif',
                bluetoothHostOff: 'Host Bluetooth nonaktif',
                bluetoothHostUnsupported: 'Bluetooth tidak didukung',
                bluetoothHostError: 'Gagal cek status Bluetooth',
                bluetoothHostUnknown: 'Status Bluetooth belum diketahui',
                bluetoothError: 'Tidak bisa membaca status Bluetooth'
            },
            promo: {
        ...
        remote: {
            ...
            authFailedTitle: 'Gagal Pairing',
            authFailedDesc: 'Token pairing salah atau kadaluarsa. Scan ulang QR dari TV.',
            authPending: 'Memverifikasi token pairing...',
            retry: 'Coba Lagi',
            prev: 'Mundur',
            next: 'Maju',
            stop: 'Stop',
            ...
            transportWifi: 'Wi-Fi (WebRTC)',
            transportBluetooth: 'Bluetooth',
            tooltipWifi: 'Gunakan Wi-Fi/WebRTC (butuh jaringan lokal + internet).',
            tooltipBluetooth: 'Gunakan Bluetooth (butuh host Android + Chrome di HP).',
            bluetoothHint: 'Gunakan Bluetooth jika tidak ada jaringan lokal. Butuh Chrome di HP.',
            bluetoothHostNote: 'Host harus build Android dengan Bluetooth Host aktif.',
            bluetoothUnsupported: 'Web Bluetooth tidak didukung di browser ini.',
            bluetoothConnect: 'Hubungkan Bluetooth',
            bluetoothConnected: 'Terhubung',
            bluetoothConnecting: 'Menghubungkan...',
            bluetoothReady: 'Siap kirim perintah',
            bluetoothNotConnected: 'Bluetooth belum terhubung.',
            bluetoothSendFailed: 'Gagal mengirim via Bluetooth.'
        }
    },
    info: {
